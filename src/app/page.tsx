		...
		<section className="space-y-6">
			<div className="rounded-lg bg-white p-6 shadow-sm">
				...
				<p className="mt-2 text-sm text-slate-600">
					Lokal-first værktøj til at samle standardiserede prompts, checklister og runs.
				</p>
				<p className="mt-4 text-sm font-medium text-emerald-600">
					Commit message forslag: <span className="font-semibold">mvp: add workflow wizard templates + runs (localStorage)</span>
				</p>
			</div>
